...
export class PropertyEditorComponent {
  ...
  private onClickHide: boolean = false;
  ...
  */
  public hideshowAdvanced() {
    if (this.currentOperatorID) {
      ...
      this.onClickHide = true;
      let currentData;
      if (this.cachedFormData === undefined) {
        currentData = cloneDeep(this.currentOperatorInitialData);
      } else {
        currentData = cloneDeep(this.cachedFormData);
      }
      ...
      this.currentOperatorInitialData = currentData;
    }
      ...
      event => {
        if (event.operatorID === this.currentOperatorID) {
          ...
          if (operator === undefined) {
            throw new Error(`operator ${event.operatorID} is undefined`);
          }
