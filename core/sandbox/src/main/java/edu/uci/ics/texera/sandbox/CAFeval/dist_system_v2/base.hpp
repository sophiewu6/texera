...
{	
	...
	using Worker = typed_actor <
		...
		reacts_to<continue_atom, int>,
		replies_to<init_atom, string>::with<request_atom,int>,
	...
	using Agent = typed_actor<
		...
		replies_to<response_atom, int, int, vector<vector<string>>>::with<work_atom, int,vector<vector<string>>>,
		replies_to<request_atom, int>::with<work_atom, int, vector<vector<string>>>,
		reacts_to<pause_atom>,
		reacts_to<resume_atom>,
