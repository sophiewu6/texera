...
public class TexeraWebApplication extends Application<TexeraWebConfiguration> {
    ...
    public static void main(String args[]) throws Exception {
        ...
        AsterixTwitterIngest.ingestKeywords("twitter_immigration_policy", "MuslimBan TravelBan  RefugeeBan ImmigrantsMakeAmericaGreat BuildTheWall MexicanWall NoBanNoWall NoRefugees immigration DACA dreamers HereToStay DreamAct immigrationpolicy", null, null);
