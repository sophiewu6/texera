...
public class MLSentimentOperator implements IOperator {
    private final MLSentimentOperatorPredicate predicate;
    ...
    private final static String PYTHONSCRIPT = Utils.getResourcePath("ml_sentiment_classify.py", TexeraProject.TEXERA_DATAFLOW).toString();
    private final static String modelPath = Utils.getResourcePath("hiv.model", TexeraProject.TEXERA_DATAFLOW).toString();
    ...
    public MLSentimentOperator(MLSentimentOperatorPredicate predicate){
